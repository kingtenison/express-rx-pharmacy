    ...
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-6 md:px-12 lg:px-16 pt-28 pb-16 md:pt-36 md:pb-24">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-row gap-4 mb-14">
              <Link href="/services">
                <motion.button
                  className="group relative px-5 py-3 sm:px-10 sm:py-5 rounded-full text-white font-semibold text-sm sm:text-base tracking-wide inline-flex items-center gap-3 overflow-hidden"
              ...
              <Link href="/contact">
                <motion.button
                  className="px-5 py-3 sm:px-10 sm:py-5 rounded-full font-semibold text-sm sm:text-base tracking-wide inline-flex items-center gap-3 border border-white/20 transition-all duration-300"
